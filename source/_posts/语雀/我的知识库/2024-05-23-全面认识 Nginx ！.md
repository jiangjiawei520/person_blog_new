...
如果本文对你有所帮助，请点个👍 👍 👍 吧！
# Nginx 概述
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270686-36b4ec1a-ee91-4011-8e1c-9948cff40b2b.png#height=149&id=RKGlQ&originHeight=149&originWidth=338&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=338)
...
用一张图表示：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270702-d6d6ec48-0148-4650-a5c7-77ed0776fa9b.png#height=438&id=zqXst&originHeight=438&originWidth=1050&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1050)
# Nginx 安装
...
用一张图清晰的展示它的层级结构：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270668-875353aa-c369-4348-9d66-63d58a3f70ec.png#height=409&id=ReVvs&originHeight=409&originWidth=176&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=176)
## 配置文件 main 段核心参数
### user
...
复制代码
```
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270676-04c9482d-716a-41ef-bd80-6c315616597d.png#height=451&id=fbbO9&originHeight=451&originWidth=614&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=614)
...
- 当访问 `fe.lion.club/search` 时，会自动帮我们重定向到 `[https://www.baidu.com](https://www.baidu.com)`。
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270681-dbe5f927-aa2a-43ec-977f-16d240b2be4a.png#height=170&id=hQdbk&originHeight=170&originWidth=762&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=762)
## 变量
...
复制代码
```
当我们访问 `[http://var.lion-test.club:8081/test?pid=121414&cid=sadasd](http://var.lion-test.club:8081/test?pid=121414&cid=sadasd)`  时，由于 `Nginx` 中写了 `return` 方法，因此 `chrome` 浏览器会默认为我们下载一个文件，下面展示的就是下载的文件内容：
```
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270703-a8dee0ea-e46a-472a-a842-b7ab1a1f83fd.png#height=1026&id=iKmac&originHeight=1026&originWidth=1060&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1060)
## 正向代理
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270692-ea1f5ee1-626a-4470-806f-6eedb1ba2642.png#height=478&id=OAEMU&originHeight=478&originWidth=1050&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1050)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270682-a714bb20-08c2-41ac-8d64-b94caa0cbd07.png#height=438&id=g4vRG&originHeight=438&originWidth=772&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=772)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270695-17551c81-46df-428b-9223-04d6cb63f8e9.png#height=655&id=YxcGo&originHeight=655&originWidth=1050&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1050)
```
语法：upstream name {
	...
}
...
1. `proxy_pass [http://192.168.100.33:8081](http://192.168.100.33:8081)`
2. `proxy_pass [http://192.168.100.33:8081/](http://192.168.100.33:8081/)`
...
复制代码
```
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270688-1a1c49b8-719b-4b14-bbd3-90a3723f7a4e.png#height=184&id=RRdBN&originHeight=184&originWidth=1006&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1006)

分析：

1. 当访问 `proxy.lion.club/proxy` 时通过 `upstream` 的配置找到 `121.42.11.34:8080` ；
2. 因此访问地址变为 `[http://121.42.11.34:8080/proxy](http://121.42.11.34:8080/proxy)` ；
...
复制代码
```
在客户端机器执行 `curl [http://balance.lion.club/balance/](http://balance.lion.club/balance/)` 命令：

![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270708-defdc16b-6abc-427c-8141-7c604464e995.png#height=222&id=g28sG&originHeight=222&originWidth=673&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=673)
...
1. 客户端（浏览器）访问 `[https://www.baidu.com](https://www.baidu.com)` 百度网站；
...
下面给出了与 URL `[http://store.company.com/dir/page.html](http://store.company.com/dir/page.html)` 的源进行对比的示例:
```
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270691-7ed2ae5d-2bde-4785-a637-af1f9c983177.png#height=130&id=iML69&originHeight=130&originWidth=339&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=339)
启用 `gzip` 同时需要客户端和服务端的支持，如果客户端支持 `gzip` 的解析，那么只要服务端能够返回 `gzip` 的文件就可以启用 `gzip` 了,我们可以通过 `Nginx` 的配置来让服务端支持 `gzip` 。下面的 `respone` 中 `content-encoding:gzip` ，指服务端开启了 `gzip` 的压缩方式。
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270691-c896f1ac-2a78-4ee0-9fe6-dc784aa5d757.png#height=219&id=s4bOZ&originHeight=219&originWidth=381&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=381)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270706-ca3ebcfe-862d-44b0-b171-fc3be2a5bbc8.png#height=379&id=ASEIr&originHeight=379&originWidth=995&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=995)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516270714-dc805ed5-2cc3-4527-b727-dced2dda9a3b.png#height=765&id=ZCqEz&originHeight=765&originWidth=1101&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1101)
# 总结
