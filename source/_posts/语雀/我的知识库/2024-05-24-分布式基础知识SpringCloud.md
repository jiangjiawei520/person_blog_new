...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147983863-092effbe-fa35-4f84-9635-3840eea8b510.png#clientId=u46e31914-6c08-4&from=paste&id=u9ca31d5c&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=u5d92125b-b12b-4dc5-954e-875ae91ba61)
由于我们的系统是分布式的，节点之间的通信是通过网络来进行的。**只要是分布式系统**，那很有可能会出现一种情况：因为一些**故障**，使得有些**节点之间不连通**了，整个网络就分成了**几块区域**。

- 数据就散布在了这些不连通的区域中，这就叫**分区**

![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147983858-c55988fa-b0b9-41d2-a1ad-e58542107905.png#clientId=u46e31914-6c08-4&from=paste&id=ud5e09dfc&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=uc4d99d5b-0a75-4da1-b29e-7695a1ff57c)
现在出现了网络分区后，此时有一个请求过来了，想要注册一个账户。
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147983863-12922ee3-da6d-4461-a91e-b173e88ea335.png#clientId=u46e31914-6c08-4&from=paste&id=u58b4347e&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=u87c34c7e-0982-41e1-a73b-a2cfc872fed)
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147984506-f86ee731-4ea1-4054-a7f7-184789786bae.png#clientId=u46e31914-6c08-4&from=paste&id=uae3374ed&originHeight=289&originWidth=1080&originalType=url&ratio=1&size=105537&status=done&style=none&taskId=u864ecc0d-64cd-4cad-9226-e334cc2cf1c)
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147984327-eaeffffe-c757-4f1f-a619-1674057faa10.png#clientId=u46e31914-6c08-4&from=paste&id=u87c7744e&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=u31fc9091-b6c7-4298-a6cb-48ff0bb6b1d)
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147984719-1e9e2975-d45d-4d6c-825f-f90275cfa72b.png#clientId=u46e31914-6c08-4&from=paste&id=u3e4be4af&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=u1a2c0d20-d207-44b8-8017-b823684061c)
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147984789-aab79ed7-0f7b-4ba8-90ba-c536131b5868.png#clientId=u46e31914-6c08-4&from=paste&id=uea35c101&originHeight=148&originWidth=1010&originalType=url&ratio=1&size=65968&status=done&style=none&taskId=ud64e5c91-96f9-4809-a9de-1c62d4d0770)
## 5.1Eureka细节
Eureka专门用于给其他服务注册的称为Eureka Server(服务注册中心)，其余注册到Eureka Server的服务称为Eureka Client。
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147985757-54bad1d6-d516-4e68-bca7-6f139e83378c.png#clientId=u46e31914-6c08-4&from=paste&id=u82456f7d&originHeight=561&originWidth=1080&originalType=url&ratio=1&size=350019&status=done&style=none&taskId=u7ea1740b-1214-4000-b82a-5398d2d12f9)
...
最后，我们就有了这张图：
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147985343-fe591cc5-2ffe-4c7b-adb1-680d1af1bba0.png#clientId=u46e31914-6c08-4&from=paste&id=u11219b03&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=u7595a3c6-8351-4993-8b7f-221a187765e)
举个例子：
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147985508-90bf4908-f146-4dfd-ad25-bc1d1d464bcf.png#clientId=u46e31914-6c08-4&from=paste&id=ued02303c&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=uf0bddd3b-32ad-4450-9119-4557bc27a8b)
...
所以，我们的图可以画成这样：
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147986409-6b02cf65-1861-486d-a685-7f1256172020.png#clientId=u46e31914-6c08-4&from=paste&id=uc7bb54e6&originHeight=580&originWidth=1080&originalType=url&ratio=1&size=379083&status=done&style=none&taskId=u9901adae-61fb-40a7-b498-d937b54e30a)
## 6.1Ribbon细节
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147986074-c9ca4283-1857-49e7-9d94-45e5c0f6f19f.png#clientId=u46e31914-6c08-4&from=paste&id=uce0cc8e6&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=ud9faaa85-1bb6-4ec0-bd8d-4dfdfb35549)
但是，如果我们在**调用多个远程服务时，某个服务出现延迟**，会怎么样？？
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147986304-afe48553-1356-47e4-bf36-28f59b5a00b8.png#clientId=u46e31914-6c08-4&from=paste&id=u447e2ba9&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=u04a9d5d2-e4f7-478d-8533-7de6b3762a1)
在**高并发**的情况下，由于单个服务的延迟，可能导致**所有的请求都处于延迟状态**，甚至在几秒钟就使服务处于负载饱和的状态，资源耗尽，直到不可用，最终导致这个分布式系统都不可用，这就是“雪崩”。
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147986497-a916e7e8-6cb3-4684-b35c-fb71b8c447ab.png#clientId=u46e31914-6c08-4&from=paste&id=u1d35aa51&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=uc422a719-8a12-4873-8b8b-46fd9e77a6d)
...
启动时的页面：
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147987763-3331577c-d51a-4870-870c-03ca8a6309db.png#clientId=u46e31914-6c08-4&from=paste&id=u9bc974d5&originHeight=639&originWidth=1080&originalType=url&ratio=1&size=323929&status=done&style=none&taskId=ub871d2b3-49b8-4492-b802-c1408d96999)
**监控单服务**的页面：
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147987551-f699894b-6643-4b15-8310-46c0b649ec67.png#clientId=u46e31914-6c08-4&from=paste&id=uda90a3c4&originHeight=622&originWidth=1047&originalType=url&ratio=1&size=252798&status=done&style=none&taskId=ue03f24ac-f735-427b-881a-c560703754c)
我们现在的服务是这样的：
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147987380-a8af68c6-f609-4364-89b4-471e1d74eb12.png#clientId=u46e31914-6c08-4&from=paste&id=ue172d8c9&originHeight=518&originWidth=1080&originalType=url&ratio=1&size=117807&status=done&style=none&taskId=ue7138a95-7f4e-49be-9d00-8e3e66f7d79)
除了可以开启单个实例的监控页面之外，还有一个监控端点 /turbine.stream是对**集群**使用的。 从端点的命名中，可以引入Turbine, 通过它来**汇集监控信息**，并将聚合后的信息提供给 HystrixDashboard 来**集中展示和监控**。
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147987411-52e680eb-7e48-4ecb-82da-92208e0036fc.png#clientId=u46e31914-6c08-4&from=paste&id=u264063b0&originHeight=440&originWidth=1080&originalType=url&ratio=1&size=127427&status=done&style=none&taskId=u4fa5418e-7bcb-43d1-acbf-d8e99157d82)
举个例子：
...
```
调用：
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147987427-576553c1-2416-4e0c-8515-6513b5b78692.png#clientId=u46e31914-6c08-4&from=paste&id=u2ffb6e94&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=u31acdad4-7737-4141-bb68-dab48a6ed50)![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632148070313-d3617862-5d4c-42a4-809d-d1db66630bd3.png#clientId=u46e31914-6c08-4&from=paste&id=u9ac1c20f&originHeight=430&originWidth=1080&originalType=url&ratio=1&size=367400&status=done&style=none&taskId=u5a10915c-f562-4975-95e0-cb6b27923e0)
# 九、引出Zuul
基于上面的学习，我们现在的架构很可能会设计成这样：
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147988529-a8cd9663-bcd9-4f03-ab9b-0e6098db40b3.png#clientId=u46e31914-6c08-4&from=paste&id=u821ed114&originHeight=753&originWidth=917&originalType=url&ratio=1&size=272696&status=done&style=none&taskId=u7b3e7528-550d-46b0-af58-cc694446c1a)
这样的架构会有两个比较麻烦的问题：
...
还是画个图来理解一下吧：
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147988789-85cc4d6f-8cd7-4714-a57f-b07316566659.png#clientId=u46e31914-6c08-4&from=paste&id=u0df54084&originHeight=438&originWidth=1080&originalType=url&ratio=1&size=265661&status=done&style=none&taskId=ue0cb91ee-d6d9-4589-9cc1-48be9c39a00)
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147988945-dcca1a15-da29-4bbc-a6f9-8e4cbeb42c3b.png#clientId=u46e31914-6c08-4&from=paste&id=u6b2c8e4f&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=ub831c488-6c72-414f-a6b6-1e7f6d0d220)
或者可以这样理解：
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147988933-64eaa00a-8288-45ce-aa8e-16ab21ca9a84.png#clientId=u46e31914-6c08-4&from=paste&id=u180e2b4b&originHeight=1&originWidth=1&originalType=url&ratio=1&size=68&status=done&style=none&taskId=u8f67dc4b-49d5-46b4-b8db-afa7b53c362)
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/12484160/1632147989337-1e421f9a-4770-4d60-9f33-5b213dac4a4f.png#clientId=u46e31914-6c08-4&from=paste&id=uaf95dd6a&originHeight=558&originWidth=936&originalType=url&ratio=1&size=110569&status=done&style=none&taskId=u7856ca2f-4da3-4fd4-98cd-e25032c8a2e)
