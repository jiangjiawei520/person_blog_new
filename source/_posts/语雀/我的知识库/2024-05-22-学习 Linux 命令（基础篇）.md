...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494105-a6d4a3e5-335e-4073-82e5-a6df7b1029c4.png#averageHue=%23d0e1c4&height=611&id=WAwvq&originHeight=611&originWidth=761&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=761)
<!--more-->
## 什么是 Linux
...
## 终端连接阿里云服务器
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494099-16b4b5d2-6bf8-48c1-9c6c-0ea72e670468.png#averageHue=%23232323&height=460&id=iWXBi&originHeight=460&originWidth=731&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=731)通过执行 `ssh root@121.42.11.34` 命令，然后输入服务器连接密码就可以顺利登陆远程服务器。从现在开始我们就可以在本地电脑操作远程服务器。
...
## 文件和目录
### 文件的组织
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494119-b08b427a-38c1-4dc0-8d5b-7482f2d22142.png#averageHue=%23140c04&height=701&id=rncIn&originHeight=701&originWidth=1024&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1024)
### 查看路径
#### pwd
显示当前目录的路径
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494093-5ca939e7-ca34-4ca0-b5a4-a23cf101f1cc.png#averageHue=%232b3033&height=150&id=PuUap&originHeight=150&originWidth=275&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=275)
#### which
查看命令的可执行文件所在路径， `Linux` 下，每一条命令其实都对应一个可执行程序，在终端中输入命令，按回车的时候，就是执行了对应的那个程序， `which` 命令本身对应的程序也存在于 `Linux` 中。
总的来说一个命令就是一个可执行程序。
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494135-7e2266a2-1ec1-4046-9b68-74b9c41dda40.png#averageHue=%230c0501&height=150&id=ldsDC&originHeight=150&originWidth=349&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=349)
### 浏览和切换目录
#### ls
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494132-2c695bd7-ef95-4890-8581-46e650cf6253.png#averageHue=%230d0703&height=614&id=ET5XG&originHeight=614&originWidth=687&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=687)
#### cd
...
复制代码
```
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494140-2d977cc2-e66e-405b-88bc-f39be0c84d52.png#averageHue=%23f9f8f6&height=321&id=qELl9&originHeight=321&originWidth=361&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=361)
...
复制代码
```
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494132-7b71c03a-d0a0-4d08-bb99-2d3f6b8017cf.png#averageHue=%23fbfaf8&height=341&id=gCNGq&originHeight=341&originWidth=361&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=361)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494130-7e8c7e2d-8775-41d4-adb5-9abc95ca5b6d.png#averageHue=%23f7f7f7&height=384&id=hkKoH&originHeight=384&originWidth=523&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=523)
...
权限的整体是按用户来划分的，如下图所示：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516494124-4278f2da-e714-4e7b-9905-8cb6c4831a40.png#height=154&id=ZBpYO&originHeight=154&originWidth=603&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=603)
...
# 小结
学习 `Linux` 知识，不仅仅可以让前端自己部署服务游刃有余，并且这里大多数的命令在 `MacOS` 上也是通用的，大大的提升了我们平时的开发效率。

作者：Lion
链接：[https://juejin.cn/post/6919252234240786446](https://juejin.cn/post/6919252234240786446)
来源：掘金
