...
## 1.1 数据库管理系统
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186753-de5c78eb-c980-495e-9866-aed7156567fb.png#averageHue=%23353532&height=254&id=PAmS7&originHeight=254&originWidth=712&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=712)
...
　　关于RDBMS的更多信息参考：[http://www.cnblogs.com/clsn/category/1131345.html](http://www.cnblogs.com/clsn/category/1131345.html)
### 1.1.3 常见数据库管理系统？
常见的数据库管理系统，及其排名情况如下：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186625-23b11224-0bca-4824-be60-010ae273b732.png#averageHue=%23f3f1f1&height=464&id=LUqeu&originHeight=464&originWidth=712&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=712)
图 - 数据库管理系统使用情况世界排名
数据来源：[https://db-engines.com/en/ranking](https://db-engines.com/en/ranking)
## 1.2 NoSQL是什么？
### 1.2.1 NoSQL简介
...
## 1.3 MongoDB简介
### 1.3.1 MongoDB是什么
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186642-d2b2b820-a756-48cf-92f3-63af9417c44f.png#averageHue=%23f9d3ae&height=263&id=gQ9Zp&originHeight=263&originWidth=511&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=511)
　　　　MongoDB并非芒果的意思，而是源于 Humongous（巨大）一词。
### 1.3.2 MongoDB的特性
　　MongoDB的3大技术特色如下所示：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186579-7d09b058-d627-4364-b9db-e906564b20b7.png#averageHue=%23ededed&height=498&id=pBMa9&originHeight=498&originWidth=581&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=581)
除了上图所示的还**支持**：
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186570-db96ff1f-0d72-4c46-a058-b45399376bc2.png#averageHue=%23f8f8f8&height=389&id=HMMa6&originHeight=389&originWidth=694&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=694)
   数据库中的对应关系，及存储形式的说明
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186594-0e4c7484-f0f2-4859-a3ac-fdc1c1d58340.png#averageHue=%23f1f1f1&height=578&id=ttYkR&originHeight=578&originWidth=712&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=712)
MongoDB与SQL的结构对比详解
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186589-9f504d7d-26fd-4a5d-9a3b-f28799ccf438.png#averageHue=%23f7f7f7&height=184&id=uUvZm&originHeight=184&originWidth=598&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=598)
**BSON格式**
...
### 1.3.5 MongoDB的优势
 　　 📢 MongoDB是开源产品
 　　 📢 On GitHub Url：[https://github.com/mongodb](https://github.com/mongodb)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186731-6f2d14b6-33d8-43b8-ac97-fde81b8fe9a1.png#averageHue=%23fdfdfd&height=449&id=lKCqG&originHeight=449&originWidth=595&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=595)
### 1.3.7 水平扩展
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186697-6ef2dd99-7831-4df6-a7c3-aad185739df8.png#averageHue=%23f8f8f8&height=381&id=B2GGY&originHeight=381&originWidth=682&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=682)
　　这样的问题是系统构架会比单体服务器复杂，搭建、维护都要求更高的技术背景。分片集群架构如下图所示：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186705-18dbd94f-f544-47ec-8340-338eab934604.png#averageHue=%23f7f1e7&height=445&id=qKSUf&originHeight=445&originWidth=636&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=636)
### 1.3.8 各存储引擎的对比
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186635-8fc55b0b-da33-4b86-927f-3e7383e6b223.png#averageHue=%23f7f7f7&height=454&id=tI8YQ&originHeight=454&originWidth=712&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=712)
### 1.3.10 MongoDB适用场景
　　网站数据、缓存等大尺寸、低价值的数据
　　在高伸缩性的场景，用于对象及JSON数据的存储。
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1627376186673-adb1791d-5cf4-4a92-89ee-9427988c72b0.png#averageHue=%23d8c4bd&height=393&id=AMsXT&originHeight=393&originWidth=631&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=631)
### 1.3.11 MongoDB 慎用场景
| **慎用场景** | **原因** |
| --- | --- |
...
　　CentOS6.X版本软件下载地址：[https://www.mongodb.org/dl/linux/x86_64-rhel62](https://www.mongodb.org/dl/linux/x86_64-rhel62)
　　　　其他版本请到进行官网下载。
### 1.4.1 安装前准备
　　在安装之前首先确认该版本软件是否支持你的操作系统。
　　　　更多详情查看：[https://docs.mongodb.com/manual/installation/](https://docs.mongodb.com/manual/installation/)
...
EOF
```
　　该方法仅限与CentOS系统使用，其他系统关闭参照官方文档：[https://docs.mongodb.com/manual/tutorial/transparent-huge-pages/](https://docs.mongodb.com/manual/tutorial/transparent-huge-pages/)
...
>  db.c.insert({url:'[http://blog.nmtui.com](http://blog.nmtui.com)'});
...
{ "_id" : ObjectId("5a4cbcfc83ec78b7bea904f9"), "url" : "[http://blog.nmtui.com](http://blog.nmtui.com)" }
重命名集合
...
　　 更多关于用户权限的说明参照：[https://docs.mongodb.com/manual/core/security-built-in-roles/](https://docs.mongodb.com/manual/core/security-built-in-roles/)
_用户创建语法_  
> {
...
| **ALTER TABLE users**
**ADD join_date DATETIME** | 在Collection 级没有数据结构概念。然而在 document级，可以通过$set在
update操作添加列到文档中。
db.users.update(
{ },
...
| **ALTER TABLE users**
**DROP COLUMN join_date** | 在Collection 级没有数据结构概念。然而在 document级，可以通过$unset
在update操作从文档中删除列。
db.users.update(
{ },
{ $unset: { join_date: "" } },
...
| **DELETE FROM users**
**WHERE status = "D"** | db.users.remove( { status: "D" } ) |
| **DELETE FROM users** | db.users.remove({}) |
| **UPDATE users**
**SET status = "C"**
**WHERE age > 25** | db.users.update(
{ age: { $gt: 25 } },
{ $set: { status: "C" } },
{ multi: true }
) |
| **UPDATE users**
**SET age = age + 3**
**WHERE status = "A"** | db.users.update(
{ status: "A" } ,
{ $inc: { age: 3 } },
{ multi: true }
) |
...
   修改后，重启服务器，即可解决该问题。
## 1.9 参考文献
> [1]  [https://docs.mongodb.com/manual/introduction/](https://docs.mongodb.com/manual/introduction/)
> [2]  [http://www.mongoing.com/docs/introduction.html](http://www.mongoing.com/docs/introduction.html)
> [3]  [https://zh.wikipedia.org/](https://zh.wikipedia.org/)
> [4]  [https://docs.mongodb.com/manual/core/security-built-in-roles/](https://docs.mongodb.com/manual/core/security-built-in-roles/)
