...
#### (1)解耦
传统模式:
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1630155655325-437321ec-bfd8-4741-b94c-875f32dd50f0.png#height=367&id=LXm1T&originHeight=367&originWidth=561&originalType=binary&ratio=1&size=0&status=done&style=none&width=561)
传统模式的缺点：

- 系统间耦合性太强，如上图所示，系统A在代码中直接调用系统B和系统C的代码，如果将来D系统接入，系统A还需要修改代码，过于麻烦！

中间件模式:
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1630155678842-5bd54669-bd93-4b20-bb45-7f29fb3bf6e5.png#height=367&id=UAMRm&originHeight=367&originWidth=489&originalType=binary&ratio=1&size=0&status=done&style=none&width=489)
中间件模式的的优点：

- 将消息写入消息队列，需要消息的系统自己从消息队列中订阅，从而系统A不需要做任何修改。
#### (2)异步
传统模式:
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1630155695286-90e75474-979c-47b9-bb72-4ee3eb93eb31.png#height=299&id=pcdof&originHeight=299&originWidth=652&originalType=binary&ratio=1&size=0&status=done&style=none&width=652)
传统模式的缺点：

- 一些非必要的业务逻辑以同步的方式运行，太耗费时间。

中间件模式:
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1630155711805-c876d78f-d993-4198-bf62-2a02eaa458ca.png#height=339&id=I8jfA&originHeight=339&originWidth=637&originalType=binary&ratio=1&size=0&status=done&style=none&width=637)
中间件模式的的优点：

- 将消息写入消息队列，非必要的业务逻辑以异步的方式运行，加快响应速度
#### (3)削峰
传统模式：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1630155733320-74685533-6870-4d2e-80b4-2aa7c61ecfe3.png#height=500&id=A5kQs&originHeight=500&originWidth=513&originalType=binary&ratio=1&size=0&status=done&style=none&width=513)
传统模式的缺点：

- 并发量大的时候，所有的请求直接怼到数据库，造成数据库连接异常

中间件模式:
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1630155751044-2fe7fa35-e96e-4b2a-b8a9-a85a50050f5c.png#height=500&id=Clako&originHeight=500&originWidth=663&originalType=binary&ratio=1&size=0&status=done&style=none&width=663)
中间件模式的的优点：
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1630155766954-7e38f9d4-f006-4b30-ba00-ef4b03131eb5.png#height=465&id=hEOht&originHeight=465&originWidth=787&originalType=binary&ratio=1&size=0&status=done&style=none&width=787)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1630155766979-e8959e5b-d9f0-4699-9c3e-0a1bd314e5a5.png#height=436&id=ysQpy&originHeight=436&originWidth=776&originalType=binary&ratio=1&size=0&status=done&style=none&width=776)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1630155766965-e8109c51-071f-4ca9-9d0b-2dff649ff5c6.png#height=516&id=naxAU&originHeight=516&originWidth=1010&originalType=binary&ratio=1&size=0&status=done&style=none&width=1010)
