...
```
 安装完成后提示如下界面：
　　![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620834217209-27374991-8162-4ffe-a8ae-a9ccb65a7f0d.png#averageHue=%23151311&height=345&id=kSZwC&originHeight=345&originWidth=902&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=902)
### 3、安装提示命令
...
```
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620834217191-7c18980a-6f77-4597-a419-35d303bdb274.png#averageHue=%23050402&height=372&id=WWy5A&originHeight=372&originWidth=692&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=692)
 显示如上界面后，表示创建成功
## 三、Oracle图形化安装
### 1、命令安装
切换到oracle用户登录系统，使用命令行跳转到data/database/database目录下，输入./runInstaller 调出安装页面；
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088467-7358892d-bba7-406c-b8a7-b2eb034d20e1.png#averageHue=%23a3a6a2&height=330&id=G0yX1&originHeight=330&originWidth=571&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=571)
调出安装页面，点击下一步进行安装，我选择仅数据库服务安装
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088693-97520dff-7931-47a2-8b41-c306cbd79d96.png#averageHue=%238c918f&height=395&id=EhyeG&originHeight=395&originWidth=677&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=677)
### 2、配置安全更新
这步可将自己的电子邮件地址填写进去（也可以不填写，只是收到一些没什么用的邮件而已）。取消下面的“我希望通过My Oracle Support接受安全更新(W)”。 如图：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088782-f5dab800-0cad-404b-86b6-5c4be9f5dd66.png#averageHue=%23e8e6d5&height=596&id=wzlwh&originHeight=596&originWidth=801&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=801)
### 3、安全选项
直接选择默认创建和配置一个数据库(安装完数据库管理软件后，系统会自动创建一个数据库实例)。 如图：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088539-c98e5704-84a9-468b-978b-d78e36bf04a5.png#averageHue=%23e9e6d6&height=592&id=vCNoR&originHeight=592&originWidth=797&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=797)
### 4、系统类
直接选择默认的桌面类就可以了，图略
### 5、典型安装
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088617-d8fe635f-a9c0-43fa-8254-e17970e5702c.png#averageHue=%23e7e4d5&height=594&id=WmlkA&originHeight=594&originWidth=796&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=796)
### 6、先决条件检查。 
安装程序会检查软硬件系统是否满足，安装此Oracle版本的最低要求。 直接下一步就OK 了。如图：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088599-1bfec3b4-a87a-4b99-8c93-6110edff7dc6.png#averageHue=%23e6e3d4&height=588&id=M9Wf2&originHeight=588&originWidth=790&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=790)
### 7、概要
安装前的一些相关选择配置信息。 可以保存成文件或不保存文件直接点完成即可，然后开始进行安装，如图：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088571-e866576a-85f5-4828-b286-023cdb6e4b95.png#averageHue=%23eae7da&height=597&id=OCh26&originHeight=597&originWidth=798&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=798)	数据库管理软件文件及dbms文件安装完后，会自动创建安装一个实例数据库，数据库的名称默认是前面设置的orcl。如图：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088603-dc8e066a-30e7-4634-a894-0de965a44593.png#averageHue=%23e2e1d3&height=476&id=iaJcy&originHeight=476&originWidth=1024&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1024)
### 8、设置账户密码
实例数据库创建完成了，系统默认把所有账户都锁定不可用(除sys和system账户可用外)，建议点右边的口令管理，将常用的scott账户解锁并输入密码。 如图：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088623-1c22aaba-8e22-4e43-a0cb-1fc17acfca09.png#averageHue=%23e8e8da&height=541&id=NB4FI&originHeight=541&originWidth=891&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=891)
解锁scott账户， 去掉前面的绿色小勾，输入密码
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088527-40329381-a1e7-4875-a6af-da4126e8476e.png#averageHue=%23eef0de&height=392&id=vLsYk&originHeight=392&originWidth=594&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=594)
安装成功，完成即可
## 三、Oracle添加实例
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088482-a53780b2-0e5e-4ec8-8edf-8210869bcc18.png#averageHue=%2333302d&height=59&id=cTlNF&originHeight=59&originWidth=333&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=333)
vim /etc/hosts
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1620802088530-1fc6cab0-6735-4280-89be-dd78710c2322.png#averageHue=%23352e2b&height=74&id=RXhbG&originHeight=74&originWidth=555&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=555)
修改完成后重启:reboot
