...
## 8、删除
> # 删除第二行规则
> 命令iptables +选项-D+操作类型（INPUT、FORWARD、OUTPUT）+行数
> iptables -D INPUT 1
...
```plsql
iptables -I INPUT -p tcp -s 0.0.0.0/0 --dport 7090 -j DROP
iptables -I INPUT -s 173.16.122.0/24 -p tcp --dport 7090 -j ACCEPT
iptables -I INPUT -s 173.16.33.0/24 -p tcp --dport 9025 -j ACCEPT

iptables -I INPUT -p tcp -s 0.0.0.0/0 --dport 2181 -j DROP
iptables -I INPUT -s 173.16.33.0/24 -p tcp --dport 2181 -j ACCEPT

#容器(DOCKER-USER或者DOCKER)
...
iptables -I DOCKER-USER -s 172.16.2.52 -p tcp --dport 9010 -j ACCEPT
iptables -I DOCKER-USER -s 172.16.2.75 -p tcp --dport 9010 -j ACCEPT
iptables -I DOCKER-USER -s 172.16.2.66 -p tcp --dport 9010 -j ACCEPT
iptables -I DOCKER-USER -s 172.16.2.90 -p tcp --dport 9010 -j ACCEPT
iptables -I DOCKER-USER -s 172.16.2.72 -p tcp --dport 9010 -j ACCEPT
iptables -I DOCKER-USER -s 172.16.2.67 -p tcp --dport 9010 -j ACCEPT
iptables -I DOCKER-USER -s 172.16.2.64 -p tcp --dport 9010 -j ACCEPT
iptables -I DOCKER-USER -s 172.16.2.63 -p tcp --dport 9010 -j ACCEPT
