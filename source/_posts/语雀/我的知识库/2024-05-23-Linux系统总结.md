...
---
# 前言
在自己的电脑安装虚拟机，虚拟机中再去安装 `CentOS` 系统。
# Linux 基础
## 操作系统
操作系统 `Operating System` 简称 `OS` ，是软件的一部分，它是硬件基础上的第一层软件，是硬件和其它软件沟通的桥梁。
操作系统会控制其他程序运行，管理系统资源，提供最基本的计算功能，如管理及配置内存、决定系统资源供需的优先次序等，同时还提供一些基本的服务程序。
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180231-f01c9c3a-4dc2-407f-8c49-b90ef28e845a.png#averageHue=%23d0e1c4&height=611&id=yUJWz&originHeight=611&originWidth=761&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=761)
## 什么是 Linux
<!--more-->
...
## 终端连接阿里云服务器
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180248-f0bce5ea-15b4-4041-876d-2a73cb97d834.png#averageHue=%23232323&height=460&id=x2pLY&originHeight=460&originWidth=731&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=731)
...
## 文件和目录
### 文件的组织
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516185277-3dc69e93-0b6d-4d37-b10b-0ed6cea5233e.png#averageHue=%23140c04&height=701&id=KnJPX&originHeight=701&originWidth=1024&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1024)
### 查看路径
#### pwd
显示当前目录的路径
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180233-162068a4-b0be-4c23-a686-d597840cfc88.png#averageHue=%232b3033&height=150&id=BU2Sv&originHeight=150&originWidth=275&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=275)
#### which
查看命令的可执行文件所在路径， `Linux` 下，每一条命令其实都对应一个可执行程序，在终端中输入命令，按回车的时候，就是执行了对应的那个程序， `which` 命令本身对应的程序也存在于 `Linux` 中。
总的来说一个命令就是一个可执行程序。
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180208-b8bd3eb4-61a4-4858-97f9-aaee8271eab5.png#averageHue=%230c0501&height=150&id=EYru1&originHeight=150&originWidth=349&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=349)
### 浏览和切换目录
#### ls
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180275-a44591b9-334d-4876-a831-71f7e0331f22.png#averageHue=%230d0703&height=614&id=JLbAh&originHeight=614&originWidth=687&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=687)
#### cd
...
```
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180247-4233b1e6-8b66-4873-abb1-21bc07399817.png#averageHue=%23f9f8f6&height=321&id=YiVQ5&originHeight=321&originWidth=361&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=361)
...
```
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180234-765efcbd-0ee1-4b47-bf2a-089424360ac1.png#averageHue=%23fbfaf8&height=341&id=Pk02i&originHeight=341&originWidth=361&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=361)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180230-84df6447-27d9-4bca-b724-55b1d8196a59.png#averageHue=%23f7f7f7&height=384&id=xsgND&originHeight=384&originWidth=523&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=523)
...
权限的整体是按用户来划分的，如下图所示：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180237-27dade55-c4d8-4a4e-80e3-88017b81cdc4.png#averageHue=%23e9e2de&height=154&id=f4s7i&originHeight=154&originWidth=603&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=603)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180244-74fbe7f6-4765-43db-92da-0191815b1576.png#averageHue=%23050505&height=455&id=V5sQd&originHeight=455&originWidth=593&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=593)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180248-bcc633e8-62ac-43d7-a841-7dd6cd195220.png#averageHue=%23f1f1f1&height=476&id=FW4p2&originHeight=476&originWidth=665&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=665)
### 重定向
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180235-f001db73-8d57-4a16-898d-adf18496f763.png#averageHue=%23070707&height=337&id=LLmNg&originHeight=337&originWidth=609&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=609)
#### 输入重定向 `<`
`<` 符号用于指定命令的输入。
```
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180243-4f18ccb9-4c93-4353-a227-a43f80f667d9.png#averageHue=%230d0d0d&height=120&id=yWWXq&originHeight=120&originWidth=818&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=818)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180243-19e7935a-7ee7-4b55-b91f-c343447259f1.png#averageHue=%23fbfafa&height=1047&id=aOdXL&originHeight=1047&originWidth=1167&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1167)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180237-a515f370-099f-48ab-9884-612576e9319f.png#averageHue=%23fcfba9&height=568&id=imGZ2&originHeight=568&originWidth=390&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=390)
### tar
创建一个 `tar` 归档。
#### 基础用法
```
...
用一张图表示三种模式如何切换：
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516180290-0fd0ad7b-6e5f-414b-82e2-bfa25a1019dd.png#averageHue=%23f7f2ee&height=460&id=kBL8m&originHeight=460&originWidth=645&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=645)
## 基本操作
### 打开 Vim
