...
## 前言
[前端视角学习 Linux 系统（入门篇）](https://juejin.cn/post/6919252234240786446)一文中学习了很多 `Linux` 命令，在这个基础之上，让我们来学习 `Linux` 中更加高级的命令，完成“青铜”到“钻石”的蜕变。
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516507200-77ad5c8a-2424-4641-b7f4-bef4ca71e520.png#averageHue=%23050505&height=455&id=ORRks&originHeight=455&originWidth=593&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=593)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516507203-f16d4ae0-444d-4817-b138-c5f4bab19476.png#averageHue=%23f1f1f1&height=476&id=x5QsI&originHeight=476&originWidth=665&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=665)
### 重定向
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516507215-618d4ecd-ebe8-455a-89cb-26b8d8a75089.png#averageHue=%23070707&height=337&id=qoAcK&originHeight=337&originWidth=609&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=609)
#### 输入重定向 `<`
`<` 符号用于指定命令的输入。
```
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516507197-7435540c-5f3c-4646-aa3c-e1110bb71d07.png#averageHue=%230d0d0d&height=120&id=R2Tzx&originHeight=120&originWidth=818&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=818)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516507188-140da979-ad6a-4ebe-a98b-b9d78052cac8.png#averageHue=%23fbfafa&height=1047&id=tml4O&originHeight=1047&originWidth=1167&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1167)
...
![](https://cdn.nlark.com/yuque/0/2021/png/12484160/1626516507203-e5092982-d35d-48ac-85ed-f99339860ed4.png#averageHue=%23fcfba9&height=568&id=eLF07&originHeight=568&originWidth=390&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=390)
### tar
创建一个 `tar` 归档。
#### 基础用法
```
...
## 小结
通过本文我们学习了，`Linux` 较核心的概念，如“重定向”，“管道”，“流”，“守护进程” 等概念。同时也学习了一些进阶型的指令，如进程的“查看”与“管理”。并且对于文件的操作也有进一步的学习，如“文件压缩”、“文件备份”等等操作。
相信通过 `Linux` 命令进阶篇的学习后，会对 `Linux` 有更进一步的理解，关于 `Linux` 的学习还远不止于此，未来的路还很长，一起加油。

作者：Lion
链接：[https://juejin.cn/post/6927040867756834823](https://juejin.cn/post/6927040867756834823)
来源：掘金
