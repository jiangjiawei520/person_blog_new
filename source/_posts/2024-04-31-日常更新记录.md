...
1、问题跟踪表204、185、187、190
2、计算中心相关问题修复
3、OA列表查询慢问题修复

```
ALTER TABLE "public"."modelplatform_operator_server" 
  ADD COLUMN "type" varchar(2) NOT NULL;

COMMENT ON COLUMN "public"."modelplatform_operator_server"."type" IS '节点类型 通用节点(0)，专用节点(1)';
```
